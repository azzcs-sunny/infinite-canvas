...
- Configure the fixed `https://ai.wcapis.com/` user provider with an API key, image model, and video model, alongside text/audio preferences and generation options.
